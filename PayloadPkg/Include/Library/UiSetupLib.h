/** @file
  ...
  The real implementation is in PayloadPkg/OsLoader/UiSetupLib.inf.
  The NULL stub is in PayloadPkg/Library/UiSetupLibNull/UiSetupLibNull.inf.
...
/**
  ...
  @retval EFI_UNSUPPORTED  Feature is disabled (NULL library).
